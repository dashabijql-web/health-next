import type { IncidentDemoScene, OperatorAccount, PeopleDemoScene } from './types'
...
export function isWritableScene(scene: IncidentDemoScene | PeopleDemoScene): boolean {
