      ...
      <header class="glass-bar glass-bar--top">
        <div class="top-left">
          <div class="top-title-group">
            ...
            <span class="badge-pill">演示环境</span>
          </div>
        </div>
      ...
      <div class="dialog-content">
        ...
        <div class="preset-group">
          ...
          <div class="preset-chips">
            ...
            <button
              type="button"
              class="preset-btn"
              @click="applyPreset('作业手环佩戴信号偏弱，请确认佩戴贴合度。')"
            >
              手环佩戴复测
            </button>
          </div>
        ...
        <div class="textarea-box">
          <textarea
            ...
            maxlength="50"
            rows="3"
            placeholder="输入调度或健康指令（最多50字）..."
            class="dialog-textarea"
          ></textarea>
          <span class="char-count" :class="{ 'is-limit': msgContent.length >= 50 }">
            {{ msgContent.length }}/50
          </span>
        </div>

        <div class="dialog-disclaimer">
          <span class="disclaimer-tag">免责提示:</span>
          <span>当前调度平台处于演示模拟模式，消息将作为仿真指令处理。</span>
        </div>
      </div>
